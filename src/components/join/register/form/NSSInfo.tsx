...
export default function NSSInfo({
  ...
  const toggleInterest = (interest: string) => {
    if (selectedInterests.includes(interest)) {
      ...
      onChange("areas_of_interest", [...selectedInterests, interest]);
    }
  };
    ...
    <section className="mb-14">
      ...
      <div className="mb-8">
        ...
        <input
          ...
          onChange={(e) => onChange("languages_known", e.target.value)}
      ...
      <div className="mb-8">
        ...
        <textarea
          ...
          onChange={(e) =>
            onChange("previous_volunteer_experience", e.target.value)
          }
      ...
      <div className="mb-8">
        ...
        <textarea
          rows={5}
          value={formData.why_join_nss || ""}
          onChange={(e) => onChange("why_join_nss", e.target.value)}
          ...
          {availabilityOptions.map((item) => (
            ...
            >
              <input
                ...
                onChange={() => onChange("availability", item)}
                className="h-5 w-5"
              />
