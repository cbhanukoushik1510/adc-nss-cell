    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-[#0F2B7B] via-[#1746A2] to-[#2563EB] py-24 text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-6 text-center">
        ...
        <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-blue-100">
          Our volunteers are the heart of every NSS activity. Through teamwork,
          leadership, compassion, and community service, they create a positive
          impact and inspire meaningful change.
        </p>
